...
const UI_TRANSLATIONS = {
    'fr': {
        ...
        'attachment-badge-label': '📎 PIÈCE JOINTE REÇUE',
        'attachment-cta-label': 'Cliquer pour examiner en grand 🔍',
        'lightbox-title-default': 'Pièce à conviction',
        'lightbox-hint': '🔍 Défilez ou zoomez pour inspecter chaque détail de la capture',
    ...
    'en': {
        ...
        'btn-hint-label': 'Clue',
        'attachment-badge-label': '📎 RECEIVED ATTACHMENT',
        'attachment-cta-label': 'Click to inspect in high-res 🔍',
        'lightbox-title-default': 'Evidence Item',
        'lightbox-hint': '🔍 Scroll or pinch to inspect every detail of the screenshot',
