    ...
    with Session(target_engine) as session:
        ...
        cases_data = [
            ...
            # DOSSIER 5
            {
                ...
                "brief_fr": "Un document PDF portant le sceau républicain et une signature officielle circule en masse, annonçant l'instauration d'une taxe annuelle de 50 000 FCFA sur chaque panneau solaire domestique.",
            ...
            # DOSSIER 6 (VRAI / PIÈGE)
            {
                ...
                "brief_fr": "Une publication virale montre la photo de tomates géantes et difformes accompagnée d'une alerte : « Voilà ce que les OGM font à nos aliments ! BOYCOTTEZ les supermarchés ! ». L'aspect inhabituel des fruits suscite une vive émotion sur les réseaux sociaux.",
            ...
            # DOSSIER 8
            {
                ...
                "brief_fr": "Une séquence vidéo de 10 secondes très partagée montre un député poussant violemment un membre de l'opposition en plein hémicycle, provoquant un tollé médiatique immédiat.",
            ...
            # DOSSIER 9
            {
                ...
                "brief_fr": "Un enregistrement audio explosif circule sur les réseaux sociaux la veille des élections. On y entend distinctement la voix d'un candidat prononçant des propos scandaleux.",
            ...
            # DOSSIER 10
            {
                ...
                "brief_fr": "Un message d'alerte rouge partagé sur WhatsApp supplie de contacter d'urgence un numéro pour un don de sang vital pour une fillette hospitalisée.",
            ...
            # DOSSIER 13
            {
                ...
                "brief_fr": "Une vidéo circule à minuit montrant le Maire déclarer un couvre-feu immédiat dans toute la ville.",
            ...
            # DOSSIER 14
            {
                ...
                "brief_fr": "Kevin affirme qu'après l'installation d'une antenne relais 6G, tous les moineaux ont mystérieusement disparu de son quartier du jour au lendemain.",
            ...
            # DOSSIER 17
            {
                ...
                "brief_fr": "Une rumeur virale alarmiste prétend qu'une cyberattaque d'envergure va couper le réseau électrique national pendant plusieurs semaines.",
            ...
            # DOSSIER 18
            {
                ...
                "brief_fr": "Une capture d'écran d'un tweet attribué à la Préfecture annonce une restriction historique interdisant l'utilisation des douches en semaine en raison de la sécheresse.",
            ...
            # DOSSIER 19
            {
                ...
                "brief_fr": "Une cagnotte en ligne largement relayée diffuse des photos poignantes d'enfants orphelins et appelle aux dons d'urgence pour sauver leur structure d'accueil.",
            ...
            # DOSSIER 20
            {
                ...
                "brief_fr": "Une publication virale affirme que les nouveaux compteurs électriques connectés émettent des ondes dangereuses pour la santé et enregistrent les conversations des foyers.",
