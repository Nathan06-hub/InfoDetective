    ...
    with Session(target_engine) as session:
        ...
        cases_data = [
            # DOSSIER 1 : Alerte Couvre-feu à Ouagadougou
            {
                ...
                "brief_fr": "Sur Facebook, une page nommée 'Minestère de la sécurité' a publié la capture d'un communiqué officiel estampillé Primature du Burkina Faso déclarant un couvre-feu immédiat de 17h à 4h du matin. Les marchés et commerces ferment précipitamment à Ouagadougou, mais une faute d'orthographe sur le nom de la page attire votre attention.",
                "brief_en": "On Facebook, a page named 'Minestère de la sécurité' posted a government press release claiming a 5 PM curfew in Ouagadougou. Citizens panic, but a typo in the page name raises suspicions.",
